...
import { Mail, Lock, User, MessageCircle, ArrowRight, Globe, Zap, Users } from "lucide-react";
      ...
      <div className="relative z-10 flex flex-col lg:flex-row w-full max-w-5xl rounded-3xl overflow-hidden shadow-2xl border border-base-content/10">
        ...
        <div className="w-full lg:w-1/2 bg-base-100 p-10 flex flex-col justify-between gap-8">
          ...
          <button
            ...
            className="btn btn-outline w-full rounded-xl gap-3 font-bold text-sm border-base-content/20 hover:border-primary hover:text-primary hover:bg-primary/5"
          >
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-base-content/30 font-semibold uppercase tracking-widest">or</span>
            <div className="flex-1 h-px bg-base-content/10" />
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            <div className="form-control gap-1">
              <label className="label py-0">
                <span className="label-text text-xs font-semibold tracking-widest uppercase text-base-content/40">Full Name</span>
              </label>
            ...
            <div className="form-control gap-1">
              <label className="label py-0">
                <span className="label-text text-xs font-semibold tracking-widest uppercase text-base-content/40">Email</span>
              </label>
              <label className="input input-bordered flex items-center gap-3 bg-base-200 border-base-content/10 focus-within:border-primary focus-within:bg-base-100 transition-all">
            ...
            <div className="form-control gap-1">
              <label className="label py-0">
                <span className="label-text text-xs font-semibold tracking-widest uppercase text-base-content/40">Password</span>
              </label>
              <label className="input input-bordered flex items-center gap-3 bg-base-200 border-base-content/10 focus-within:border-primary focus-within:bg-base-100 transition-all">
              ...
              <p className="text-[10px] text-base-content/30 mt-1 pl-1">
        ...
        <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-primary/90 to-secondary/80 flex-col items-center justify-center p-12 gap-10 relative overflow-hidden">
          ...
          <div className="flex flex-col gap-3 w-full max-w-xs z-10">
            {[
              ...
              <div key={label} className="flex items-center gap-3 bg-primary-content/10 backdrop-blur-sm rounded-2xl px-4 py-3 border border-primary-content/10">
                <div className="bg-primary-content/20 rounded-lg p-2 text-primary-content">{icon}</div>
                <div>
