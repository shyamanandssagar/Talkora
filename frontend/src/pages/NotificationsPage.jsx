              ...
              <section className="space-y-3">
                ...
                <div className="space-y-2.5">
                  {incomingRequests.map((request) => {
                    // FIX 1: Guard against null sender (deleted user / unpopulated ref)
                          ...
                          <div className="relative flex-shrink-0">
                            <div className="w-12 h-12 rounded-xl overflow-hidden ring-2 ring-primary/15 group-hover:ring-primary/35 ring-offset-1 ring-offset-base-200 transition-all duration-300">
                              <img
                                ...
                                crossOrigin="anonymous"  // FIX 2: Prevents SVG CORS block
                              />
                            </div>
                          </div>
              ...
              <section className="space-y-3">
                ...
                <div className="space-y-2.5">
                  {acceptedRequests.map((notification) => {
                    // Guard against null recipient (deleted user / unpopulated ref)
