...
import { MessageCircle, MailCheckIcon, RefreshCwIcon } from "lucide-react";
...
const VerifyEmailPage = () => {
  ...
  const { mutate: verifyMutation, isPending } = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success("Email verified! Welcome to Talkora 🎉");
      navigate("/onboarding");
    },
    onError: (err) => {
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-base-100 rounded-3xl border border-base-content/10 shadow-2xl p-10 flex flex-col items-center gap-8">
          ...
          <div className="text-center space-y-1">
            <h2 className="text-2xl font-black text-base-content">Verify your email</h2>
